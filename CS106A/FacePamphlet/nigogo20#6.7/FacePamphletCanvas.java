...
public class FacePamphletCanvas extends GCanvas implements FacePamphletConstants {
	...
	private void displayFriends(FacePamphletProfile profile) {
		...
		add(friends, getWidth() / 2, (TOP_MARGIN + IMAGE_MARGIN + name.getHeight()) + friends.getHeight());
		...
		while (iterator.hasNext()) {
			...
			add(friend, getWidth() / 2, (TOP_MARGIN + IMAGE_MARGIN + name.getHeight()) + friends.getHeight()
					+ friend.getHeight() + 2 + (x * (2 + friend.getHeight())));
		}
	}
